...
import { Facebook, Instagram, Twitter, Mail, Leaf, ExternalLink } from "lucide-react"
    ...
    <footer className="bg-gradient-to-b from-amber-50 to-amber-100 border-t border-amber-200">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-2xl font-serif font-bold text-amber-900">Som Sattva</h3>
            </div>
            <p className="text-amber-800/70 mb-4 text-sm leading-relaxed">
              Pure. Honest. Clean Nutrition. Bringing you food as nature intended.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-amber-800/70">
              ...
              <li>
                <Link href="/shop" className="hover:text-amber-900 transition-colors cursor-pointer">
                  Wildflower Honey
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-amber-800/70">
              <li>
                <Link href="/about" className="hover:text-amber-900 transition-colors cursor-pointer">
                  About Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contact" className="hover:text-amber-900 transition-colors cursor-pointer">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/" className="hover:text-amber-900 transition-colors cursor-pointer">
                  Home
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-amber-800/70 mb-4 text-sm">Subscribe for wellness tips and clean nutrition insights</p>
            {subscribed ? (
              <div className="p-3 bg-green-100 text-green-800 rounded-lg text-sm">Thanks for subscribing!</div>
            ) : (
        ...
        <div className="border-t border-amber-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-amber-800/60 text-sm">
          <p>&copy; 2025 Som Sattva. All rights reserved. Crafted with purity and truth.</p>
