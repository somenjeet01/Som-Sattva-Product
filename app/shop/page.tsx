  ...
  const products = [
    {
      ...
      price: 299,
      originalPrice: 449,
      description: "100% Pure, NMR Tested Raw Forest Honey. No additives, no heating, just nature's pure golden gift.",
      benefits: "NMR Tested, Raw & Unprocessed, Immune Boost, Energy Support",
      image: "/golden-honey-jar-with-natural-organic-honey.jpg",
      size: "500g",
      amazonLink: "https://www.amazon.in/Sattva-Forest-Honey-500gm-Tested/dp/B0FWJQSYF6",
      rating: 5,
      reviews: 1,
      discount: 33,
    },
    {
      ...
      price: 399,
      originalPrice: 499,
      description: "Rich blend from multiple wildflower sources, deep amber color with complex floral notes",
      benefits: "Antioxidants, Energy boost, Immune support",
      image: "/golden-honey-jar-wildflower-blend.jpg",
      size: "500g",
      rating: 4.8,
      reviews: 42,
      discount: 20,
    ...
    {
      id: "acacia",
      name: "Som Sattva Acacia Honey",
      price: 349,
      originalPrice: 449,
      description: "Delicate and mild, never crystallizes. Perfect for daily use and kids",
      benefits: "Mild flavor, Long shelf life, Great for sensitive palates",
      image: "/clear-golden-acacia-honey-jar.jpg",
      size: "500g",
      rating: 4.9,
      reviews: 38,
      discount: 22,
    ...
    <div className="min-h-screen bg-amber-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm text-amber-700">Items in Cart</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold text-amber-900 mb-4">Shop Our Collection</h1>
          <p className="text-lg text-amber-700/60">Premium Som Sattva honey varieties for every need</p>
        </div>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-amber-900/70 mb-4 text-sm">{product.description}</p>
                ...
                <div className="mb-6 p-4 rounded-lg bg-amber-50 border border-amber-100">
                  <p className="text-xs font-semibold text-amber-900 mb-1">Key Benefits:</p>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-amber-800 text-white rounded-lg font-semibold hover:bg-amber-900 transition-all shadow-md hover:shadow-lg cursor-pointer"
                  >
                    Add to Cart
                  </button>
                  <a
        ...
        {totalItems > 0 && (
          <div className="bg-white rounded-2xl p-8 border border-amber-100 shadow-lg">
              ...
              {cart.map((item, idx) => (
                <div key={idx} className="flex justify-between items-center text-amber-900">
                  <div>
                    ...
                    <span className="text-sm text-amber-700 ml-2">x{item.quantity}</span>
                  </div>
                  <div className="flex items-center gap-4">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-3xl font-bold text-amber-800">₹{totalPrice.toLocaleString()}</span>
            </div>
            <button
        ...
        {totalItems === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-amber-900/60 text-lg">Your cart is empty. Add some honey to get started!</p>
          </div>
        )}
      </div>
    </div>
